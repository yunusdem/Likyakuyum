...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
			...
			<body
					...
					<table style="border-color:blue; " border="0" cellspacing="0px" width="800"
						...
						<tbody>
							<tr valign="top">
								<td width="40%" style="margin:0; padding:0;">
									...
									<table align="center" border="0" width="100%"
										...
										<tbody>
											...
											<tr align="left">
												<xsl:for-each
												select="n1:CreditNote/cac:AccountingSupplierParty/cac:Party">
												<td align="left">
									...
									<table border="0" width="100%" style="margin:0; padding:0;">
										<tbody>
											...
											<!-- İade Edilen Fatura No -->
											<xsl:for-each select="n1:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:ID">
												<tr align="left">
													<td align="left" valign="top" id="ettnTable">
														<span style="font-weight:bold;">
															<xsl:text>İade Edilen Fatura No:&#160;</xsl:text>
														</span>
														<xsl:apply-templates/>
													</td>
												</tr>
											...
											<!-- İade Edilen Fatura Tarihi -->
											<xsl:for-each select="n1:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:IssueDate">
												<tr align="left">
													<td align="left" valign="top" id="ettnTable">
														<span style="font-weight:bold;">
															<xsl:text>İade Edilen Fatura Tarihi:&#160;</xsl:text>
														</span>
														<xsl:apply-templates/>
													</td>
												</tr>
													...
													<table align="center" border="0">
														<tbody>
															<tr>
																<td style="width:469px;" align="left">
																	<span style="font-weight:bold;">
																		<xsl:text>Gönderiyi Taşıyana İlişkin Bilgiler</xsl:text>
																	</span>
																</td>
															</tr>
															...
															<!-- Taşıyıcı bilgileri -->
															<xsl:for-each
																select="n1:CreditNote/cac:Delivery/cac:DeliveryParty">
																<!-- Unvan -->
																<xsl:if test="cac:PartyName/cbc:Name">
																	<tr>
																		<td style="width:469px;" align="left">
																			<span style="font-weight:bold;">Taşıyıcı Unvan: </span>
																			<xsl:value-of
																				select="normalize-space(cac:PartyName/cbc:Name)"/>
																		</td>
																	</tr>
																</xsl:if>
																...
																<xsl:for-each
																	...
																	<xsl:if
																		test="@schemeID and normalize-space(.) != ''">
																		<tr>
																			<td style="width:469px;" align="left">
																				<span style="font-weight:bold;">
								...
								<td width="20%" align="center" valign="top" style="padding: 0; margin: 0;">
									<img style="width:91px; display:block; margin-bottom:2px;" 
										alt="E-Müstahsil Makbuz Logo"
								...
								<td align="right">
									...
									<div id="qrvalue"
										...
										> {"vkntckn":"<xsl:value-of
											select="n1:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID = 'TCKN' or @schemeID = 'VKN']"
										/>", "avkntckn":"<xsl:value-of
											select="n1:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID[@schemeID = 'TCKN' or @schemeID = 'VKN']"
										/>", "senaryo":"<xsl:value-of
											select="translate(n1:CreditNote/cbc:ProfileID, 'ĞÜŞÇİÖğüşçıö', 'GUSCIOguscio')"
										/>", "tip":"<xsl:value-of
											select="translate(n1:CreditNote/cbc:CreditNoteTypeCode, 'ĞÜŞÇİÖğüşçıö', 'GUSCIOguscio')"
										/>", "tarih":"<xsl:value-of
											select="n1:CreditNote/cbc:IssueDate"/>",
											"no":"<xsl:value-of select="n1:CreditNote/cbc:ID"/>",
											"ettn":"<xsl:value-of select="n1:CreditNote/cbc:UUID"
										/>", "parabirimi":"<xsl:value-of
											select="n1:CreditNote/cbc:DocumentCurrencyCode"/>",
											"malhizmettoplam":"<xsl:value-of
											select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:LineExtensionAmount"
										/>", "odenecek":"<xsl:value-of
											select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:PayableAmount"
										/>" } </div>
									<script type="text/javascript">
									...
									<br/>
									<table border="1" id="despatchTable" style="border-collapse:collapse;">
										<tbody>
											<tr>
												<td style="width:105px;" align="left">
													<span style="font-weight:bold;"><xsl:text>Özelleştirme No:</xsl:text></span>
												</td>
											...
											<tr>
												<td align="left">
													<span style="font-weight:bold;"><xsl:text>Senaryo:</xsl:text></span>
												</td>
												<td align="left">
											...
											<tr>
												<td align="left">
													<span style="font-weight:bold;"><xsl:text>Tip:</xsl:text></span>
												</td>
												<td align="left">
											...
											<tr>
												<td align="left">
													<span style="font-weight:bold;"><xsl:text>Belge No:</xsl:text></span>
												</td>
												<td align="left">
											...
											<tr>
												<td align="left">
													<span style="font-weight:bold;"><xsl:text>Düzenlenme Tarihi:</xsl:text></span>
												</td>
												<td align="left">
											...
											<tr>
												<td align="left">
													<span style="font-weight:bold;"><xsl:text>Düzenlenme Zamanı:</xsl:text></span>
												</td>
												<td align="left">
					...
					<table border="1" id="lineTable" width="800">
						<tbody>
							<tr class="lineTableTr">
								...
								<!--
								<xsl:if
									test="(//n1:CreditNote/cbc:ProfileID='HKS')">
								...
								<xsl:if
									test="(//n1:CreditNote/cbc:ProfileID='HKS') and (//n1:CreditNote/cbc:CreditNoteTypeCode='SATIS')">
				...
				<table id="budgetContainerTable" width="800px">
					...
					<tr align="right">
						...
						<td class="lineTableBudgetTd" style="width:82px; " align="right">
							<xsl:for-each
								select="n1:CreditNote/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount">
								<xsl:call-template name="Curr_Type"/>
							</xsl:for-each>
						</td>
					</tr>
					...
					<xsl:for-each select="n1:CreditNote/cac:TaxTotal/cac:TaxSubtotal">
						<xsl:if
							test="//n1:CreditNote/cbc:DocumentCurrencyCode != 'TRY' and //n1:Invoice/cbc:DocumentCurrencyCode != 'TRL'">
							<tr align="right">
								<td/>
								<td class="lineTableBudgetTd" align="right" width="200px">
									<span style="font-weight:bold; ">
					...
					<tbody>
						<tr align="left">
							<td id="notesTableTd2" height="100">
								<xsl:for-each
									select="//n1:CreditNote/cac:Delivery/cbc:ActualDeliveryDate">
									<b>&#160;&#160;&#160;&#160;&#160; Teslim Tarihi: </b>
									<xsl:value-of select="."/>
									<br/>
								</xsl:for-each>
	...
	<xsl:template name="Delivery_Title">
			...
			<xsl:if test="cbc:Telephone or cbc:Telefax">
				<tr align="left">
					<td style="width:469px; " align="left">
						...
						<xsl:text>&#160;</xsl:text>
						<xsl:if test="cbc:Name = 'IADEKODU' and normalize-space(cbc:ID) != ''">
							<tr>
								<td style="width:469px;" align="left">
									<xsl:text>İADE KODU: </xsl:text>
									<xsl:value-of select="normalize-space(cbc:ID)"/>
								</td>
							</tr>
						</xsl:if>
						<xsl:if test="cbc:Name = 'SMS' and normalize-space(cbc:ID) != ''">
							<tr>
								<td style="width:469px;" align="left">
