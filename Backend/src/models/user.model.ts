...
export class UserRepository {
  private static users: UserModel[] = [...initialUsers];
  ...
  public static async create(userData: Omit<UserModel, "id" | "createdAt" | "updatedAt">): Promise<UserModel> {
  ...
  public static async update(id: string, updateData: Partial<UserModel>): Promise<UserModel | null> {
