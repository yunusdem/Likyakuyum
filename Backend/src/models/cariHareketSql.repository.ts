  ...
  public static async findAll(
    ...
    try {
      ...
      if (filters?.search && filters.search.trim()) {
        ...
        whereClauses.push(
          "(C.[KOD] LIKE @search OR C.[AD] LIKE @search OR H.[ACIKLAMA] LIKE @search OR V.[KOD] LIKE @search OR V.[AD] LIKE @search)"
        );
      }
      ...
      const linesByHeaderId = new Map<number, CariHareketSatiriModel[]>();
