...
router.post("/gelen/:uuid/cevap", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.gelenCevapVer);
...
router.post("/giden/taslak", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.taslakGonder);
router.post("/giden/:uuid/iptal", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.taslakIptal);
// e-Fatura GERÇEK GÖNDERİMİ (Faz 7) — belge GİB'e gider, GERİ ALINAMAZ.
router.post("/giden/gonder", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.faturaGonder);
router.post("/giden/:uuid/onayla", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.taslakOnayla);
...
router.post("/giden/:uuid/mail", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.belgeMailGonder);
/* ------------------------------------------------------------------ e-İrsaliye (Faz 9) */
...
router.post("/irsaliye/gonder", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.irsaliyeGonder);
...
router.post("/earsiv/gonder", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.earsivGonder);
router.post("/earsiv/:uuid/iptal", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.earsivIptal);
...
router.post("/gider-pusulasi/gonder", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER), EbelgeController.giderPusulasiGonder);
