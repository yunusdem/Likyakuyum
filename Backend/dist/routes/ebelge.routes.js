...
router.post("/gelen/:uuid/cevap", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.gelenCevapVer);
...
router.post("/giden/taslak", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.taslakGonder);
router.post("/giden/:uuid/iptal", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.taslakIptal);
// e-Fatura GERÇEK GÖNDERİMİ (Faz 7) — belge GİB'e gider, GERİ ALINAMAZ.
router.post("/giden/gonder", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.faturaGonder);
router.post("/giden/:uuid/onayla", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.taslakOnayla);
...
router.post("/giden/:uuid/mail", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.belgeMailGonder);
/* ------------------------------------------------------------------ e-İrsaliye (Faz 9) */
...
router.post("/irsaliye/gonder", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.irsaliyeGonder);
...
router.post("/earsiv/gonder", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.earsivGonder);
router.post("/earsiv/:uuid/iptal", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.earsivIptal);
...
router.post("/gider-pusulasi/gonder", authorizeRoles(UserRole.ADMIN, UserRole.MANAGER, UserRole.CASHIER), EbelgeController.giderPusulasiGonder);
