...
export class IskontoSqlRepository {
    ...
    static async listIskontolar(filter, dbContext) {
    ...
    static async saveIskonto(dto, dbContext) {
        ...
        request.input("ORAN", sql.Float, dto.oran !== undefined && dto.oran !== null && dto.oran !== "" ? Number(dto.oran) : null);
        request.input("TUTAR", sql.Float, dto.tutar !== undefined && dto.tutar !== null && dto.tutar !== "" ? Number(dto.tutar) : null);
        request.input("HAS_TUTAR", sql.Float, dto.hasTutar !== undefined && dto.hasTutar !== null && dto.hasTutar !== "" ? Number(dto.hasTutar) : null);
        request.input("MIN_TUTAR", sql.Float, dto.minTutar !== undefined && dto.minTutar !== null && dto.minTutar !== "" ? Number(dto.minTutar) : null);
        request.input("MAX_ISKONTO_TUTARI", sql.Float, dto.maxIskontoTutari !== undefined && dto.maxIskontoTutari !== null && dto.maxIskontoTutari !== "" ? Number(dto.maxIskontoTutari) : null);
    ...
    static async deleteIskonto(iskontoId, kaliciSil = true, dbContext) {
        const pool = await getDbPool(dbContext?.dbServer, dbContext?.dbName);
        await this.ensureSchema(pool);
        const request = pool.request();
