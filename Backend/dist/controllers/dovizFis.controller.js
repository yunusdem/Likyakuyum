...
export class DovizFisController {
     ...
     */
    static getFisList = asyncHandler(async (req, res) => {
     ...
     */
    static getFisById = asyncHandler(async (req, res) => {
        const dbContext = DovizFisController.getDbContext(req);
     ...
     */
    static saveFis = asyncHandler(async (req, res) => {
        const dbContext = DovizFisController.getDbContext(req);
        const u = req.user;
     ...
     */
    static deleteFis = asyncHandler(async (req, res) => {
        const dbContext = DovizFisController.getDbContext(req);
        const id = Number(req.params.id);
        const u = req.user;
     ...
     */
    static getVezneBakiye = asyncHandler(async (req, res) => {
        const dbContext = DovizFisController.getDbContext(req);
     ...
     */
    static getDebugInfo = asyncHandler(async (req, res) => {
        const dbContext = DovizFisController.getDbContext(req);
     ...
     */
    static getIstatistikler = asyncHandler(async (req, res) => {
        const dbContext = DovizFisController.getDbContext(req);
     ...
     */
    static getKayitsizMusteriler = asyncHandler(async (req, res) => {
        const dbContext = DovizFisController.getDbContext(req);
        const { getDbPool, getActivePool } = await import("../config/mssql.config.js");
        let pool = await getActivePool();
        if (!pool) {
