...
const ROUTE_PAGE_MAP: Record<string, { title: string; icon: React.ReactNode }> = {
  ...
  "/etiket/sayim-fisi": { title: "H- Barkodlu Ürün Sayım Fişi", icon: <IconBarcode size={20} /> },
  "/etiket/barkodlu-sayim-fisi": { title: "H- Barkodlu Ürün Sayım Fişi", icon: <IconBarcode size={20} /> },
