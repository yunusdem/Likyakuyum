...
export const DashboardMenu: MenuItemType[] = [
  ...
  // C- Kur İşlemleri
  {
    ...
    children: [
      ...
      { id: uuid(), name: "B- Günlük Fiyat Listesi", link: "kur/gunluk-fiyat-listesi" },
      { id: uuid(), name: "C- Saklanan Fiyat Listesi", link: "kur/saklanan-fiyat-listesi" },
      { id: uuid(), name: "D- Pano", link: "kur/pano" },
      { id: uuid(), name: "E- Pano Tanımı", link: "kur/pano-tanimi" },
    ],
  },
  ...
  // J- Ayarlar
  {
    ...
    children: [
      ...
      { id: uuid(), name: "D- Sarrafiye Tanımları", link: "ayarlar/sarrafiye-tanimlari" },
      { id: uuid(), name: "E- Vezne Tanımları", link: "ayarlar/vezne-tanimlari" },
      { id: uuid(), name: "F- Kullanıcı Tanımları", link: "ayarlar/kullanici-tanimlari" },
      { id: uuid(), name: "G- Yazıcı Tanımları", link: "ayarlar/yazici-tanimlari" },
      { id: uuid(), name: "H- Şifre Değişikliği", link: "ayarlar/sifre-degisikligi" },
      { id: uuid(), name: "I- Vezne Kullanıcı Eşleştirme", link: "ayarlar/vezne-kullanici-eslestirme" },
      { id: uuid(), name: "J- Numaratörler", link: "ayarlar/numeratorler" },
      { id: uuid(), name: "K- Dönemi Onayla", link: "ayarlar/donemi-onayla" },
      { id: uuid(), name: "L- Devir Ayarları", link: "ayarlar/devir-ayarlari" },
      { id: uuid(), name: "M- Devir İşlemi", link: "ayarlar/devir-islemi" },
      { id: uuid(), name: "N- Servis İşlemleri", link: "ayarlar/servis-islemleri" },
      { id: uuid(), name: "O- MASAK Malvarlıkları Dondurulanlar", link: "ayarlar/masak-dondurulanlar" },
      { id: uuid(), name: "P- Firma Tanımları", link: "ayarlar/firma-tanimlari" },
    ],
  },
];
